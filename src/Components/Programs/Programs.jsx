        ...
        <div className={style.container}>
            ...
            <div className={style.topBlock}>
                <div className={style.head}>
                    ...
                    <button className={style.duration}>Course Duration: 1 Month</button>
            ...
            <div className={style.gridCont}>
                <div className={style.gridItem}>
                    ...
                    <span>Financial Freedom</span></div>
                <div className={style.gridItem}>
                    <img className={style.gridImg} src={ideaIcon} alt="" />
                    <span>Money Management-</span> basic necessity</div>
                <div className={style.gridItem}>
                    <img className={style.gridImg} src={moneyIcon} alt="" />
                    Helps you develop a <span>habit of saving</span></div>
                <div className={style.gridItem}>
                    <img className={style.gridImg} src={noteIcon} alt="" />
                    Helps you make <span>smart financial decisions</span></div>
                <div className={style.gridItem}>
                    <img className={style.gridImg} src={timeIcon} alt="" />
                    Teaches kids <span>time value of money</span></div>
                <div className={style.gridItem}>
                    <img className={style.gridImg} src={careerIcon} alt="" />
                    Exposure to<span> career prospects</span> in finance</div>
            </div>
